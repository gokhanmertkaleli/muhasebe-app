...
public class Customer extends BaseEntity {
    ...
    private String customerType; // Kurumsal, Bireysel
    ...
    /**
     * Müşterinin borç durumunu kontrol eder
     */
    ...
    /**
     * Müşterinin alacak durumunu kontrol eder
     */
    ...
    /**
     * Kredi limitini aşıp aşmadığını kontrol eder
     */
    public boolean isOverCreditLimit() {
        if (creditLimit == null || balance == null) {
            return false;
        }
        return balance.abs().compareTo(creditLimit) > 0;
    }
}